...
def members():
    ...
    if request.method == "POST":
        ...
        if (not request.form.get("cl_num").isnumeric()) or len(request.form.get("cl_num"))<8:
            return render_template('members.html', message1="phone number invalid",clients=clients,sport=sport,membership=membership)
        ...
        if len(number)>0:
            return render_template('members.html', message3="phone number already exist",clients=clients,sport=sport,membership=membership)
        ...
        if (not request.form.get("sp_name")) and (not request.form.get("m_type"))  and  (not request.form.get("duration")) and (not request.form.get("price")) and (not request.form.get("starts_at")):    
            return render_template('members.html',message2="member added successfuly",clients=clients,sport=sport,membership=membership)
        if (not request.form.get("sp_name")) or (not request.form.get("m_type"))  or  (not request.form.get("duration")) or (not request.form.get("price")) or (not request.form.get("starts_at")):
            return render_template('members.html',message6="member added successfuly ",message4="No membership added ! Not enough informations",clients=clients,sport=sport,membership=membership)
        ...
        return render_template('members.html',message5="member and his membership added successfuly",clients=clients,sport=sport,membership=membership)
        
        
    else:
            
        return render_template('members.html',clients=clients,sport=sport,membership=membership)